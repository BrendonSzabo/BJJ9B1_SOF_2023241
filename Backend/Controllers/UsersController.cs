...
namespace Backend.Controllers
{
    public class UsersController : Controller
    {
        ...
        {
            var leagueDbContext = _context.Users.Include(u => u.Team);
        ...
        public async Task<IActionResult> Create([Bind("Id,Credits,TeamId")] User user)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LeagueDbContext.Users'  is null.");
            }
            var user = await _context.Users.FindAsync(id);
            if (user != null)
            {
